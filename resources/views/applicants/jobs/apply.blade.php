    ...
    <div class="col-lg-9 pt-4 pb-2 pb-sm-4">
      ...
      <div class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
        <div class="card-body pb-0">
          <div class="d-flex align-items-center mt-sm-n1 pb-0 mb-0 mb-lg-1 mb-xl-3">
          ...
          <div class="accordion accordion-alt accordion-orders" id="orders">
                <article class="card border-0 bg-default">
                  <div class="card-body pb-4">
                    ...
                    <div class="mx-4">
                      <form action="{{route('app_apply', ['id'=>$job->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          <?php $d=0; ?>
                              ...
                              <div class="col-sm-6">
                                <div class="mb-3">
                                  ...
                                  {{-- <div class="col-sm-6">
                                    <div class="mb-3">
                                      <label for="datepicker" class="form-label">DAte Test: </label>
                              ...
                              <div class="col-12 d-flex justify-content-end pt-3">
                                ...
                                <button class="btn btn-primary ms-3" type="submit">Apply/Upload</button>
                              </div>
                          </div>
                        </form>
                    </div>
