...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Kano E-Procurement | Admin Dashboard</title>

    <meta name="description" content="Kano State E-Procurement System">
...
{{--                    <h4 class="fs-xs fw-medium text-muted text-uppercase pb-1 mb-2">System</h4>--}}
                    <a class="nav-link fw-semibold py-2 px-0 " href="{{route('home')}}"><i class="ai-grid fs-5 opacity-60 me-2"></i>Dashboard</a>
                      <a class="nav-link fw-semibold py-2 px-0" href="{{route('applications')}}"><i class="ai-messages fs-5 opacity-60 me-2"></i>Bids</a>
                      <a class="nav-link fw-semibold py-2 px-0" href="{{route('jobs')}}"><i class="ai-card fs-5 opacity-60 me-2"></i>Tenders</a>
                      <a class="nav-link fw-semibold py-2 px-0" href="{{route('database')}}"><i class="ai-database fs-5 opacity-60 me-2"></i>Vendors</a>
                  ...
                  <nav class="nav flex-column pb-2 pb-lg-4 mb-1">
                      ...
                      <a class="nav-link fw-semibold py-2 px-0" href="{{route('settings')}}"><i class="ai-settings fs-5 opacity-60 me-2"></i>System Settings</a>
    ...
    <script src="{{asset('assets/vendor/flatpickr/dist/plugins/rangePlugin.js')}}"></script>
