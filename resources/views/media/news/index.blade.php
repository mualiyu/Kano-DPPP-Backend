    ...
    <div class="col-lg-9 pt-4 pb-2 pb-sm-4">
      <div class="d-flex align-items-center mb-4">
        <h1 class="h2 mb-0">News</h1>
          <div class="ms-auto">
              <a class="btn btn-sm btn-primary ms-auto" style="float: right;" href="{{route('show_create_news')}}">Post a news</a>
          </div>
      </div>
            ...
            @if (count($news) > 0)
                @foreach ($news as $n)
                    <tr>
                        ...
                        <td>
                            <a  onclick="event.preventDefault(); window.location.href='/web-admin/news/{{$n->id}}/news-info';" class="nav-link text-default fs-sm fw-normal text-primary py-1 pe-0 ps-1 ms-2" type="button" data-bs-toggle="tooltip" aria-label="View">
                                View
                            </a>
