            ...
            @if (count($faqs) > 0)
                @foreach ($faqs as $n)
                    <tr>
                        ...
                        <td>
                            <a  onclick="event.preventDefault(); window.location.href='/web-admin/faqs/{{$n->id}}/faq-info';" class="nav-link text-default fs-sm fw-normal text-primary py-1 pe-0 ps-1 ms-2" type="button" data-bs-toggle="tooltip" aria-label="View">
                                View
                            </a>
